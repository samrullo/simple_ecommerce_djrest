...
for currency_code in usd_fx_rates:
    ...
    fx_rate=FXRate.objects.create(currency_from=from_currency,
...
for from_currency_code in ["JPY","SOM"]:
    for to_currency_code in ["USD","JPY","SOM"]:
        ...
        from_to_fx_rate=(1/usd_to_from_currency_fx_rate)*usd_to_to_currency_fx_rate
        ...
        created_fx_rate=FXRate.objects.create(currency_from=from_currency,
                          currency_to=to_currency,
