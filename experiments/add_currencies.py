...
currencies_to_create=[("USD","US Dollars"),("JPY","Japanese Yen"),("SOM","Uzbek Som")]
...
usd_jpy_fxrate=FXRate.objects.create(currency_from=usd_currency,currency_to=jpy_currency,rate=145.00,start_date=start_date)
logger.debug(f"Created fx rate {usd_jpy_fxrate}")
usd_som_fxrate=FXRate.objects.create(currency_from=usd_currency,currency_to=som_currency,rate=12581.00,start_date=start_date)
